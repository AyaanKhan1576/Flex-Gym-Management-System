...
namespace PORJDB1
{
    public partial class TainerCreateWorkoutPlan : Form
    {
        //private int trainerID;
        public TainerCreateWorkoutPlan()
        {
            InitializeComponent();
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            // Proceed with the selectedClientID...
            TreainerCreateWorkoutPlan2 form2form = new TreainerCreateWorkoutPlan2();
            this.Hide();
            form2form.ShowDialog();
        }
        ...
        private void TainerCreateWorkoutPlan_Load(object sender, EventArgs e)
        {
