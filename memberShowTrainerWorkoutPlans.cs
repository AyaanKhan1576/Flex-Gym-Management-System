...
namespace PORJDB1
{
    public partial class memberShowTrainerWorkoutPlans : Form
    {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                string query = @"
                        ...
                        SELECT 
                            ...
                            e.Muscle_Group
                        FROM 
                            TRAINER_WORKOUT_PLAN wp
                        INNER JOIN 
                            TRAINERS t ON wp.Trainer_ID = t.Trainer_ID
                        LEFT JOIN 
                            TRAINER_CONSISTS_OF co ON wp.Plan_ID = co.Plan_ID
                        LEFT JOIN 
        ...
        public memberShowTrainerWorkoutPlans()
        {
            InitializeComponent();
            DisplayData();
        }
